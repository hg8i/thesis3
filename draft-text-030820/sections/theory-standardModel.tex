...
\midrule
-\frac{g}{\sqrt{2}}W_\mu^+[\nu_\ell\gamma^\mu \ell_L+\ubar\gamma^\mu d_L]
\centered{Charged-current quark\\interaction}  & $\frac{g}{\sqrt{2}}W_\mu^+[\ubar\gamma^\mu d_L]$     & \centered{$\feynmandiagram [ssmall,baseline=(v.base),horizontal=d to v] { {a[particle=\(W^\mu\)]} --[charged boson] v , v --[fermion] b[particle=\(q\)], {d[particle=\(q'\)]} --[fermion] v  };$} & $\frac{g}{2^{3/2}}(1-\gamma_5)$  \\[1.0em]
...
\centered{$\gamma W^+W^-$\\interaction}        &  & \centered{$\feynmandiagram [ssmall,baseline=(v.base),horizontal=d to v] { {a[particle=\(W^\mu\)]} --[charged boson,momentum=\(k\)] v , v --[charged boson,momentum=\(q\)] b[particle=\(W^\nu\)], {d[particle=\(A_\mu\)]} --[boson,momentum=\(p\)] v  };$} & \centered{$ie[g^{\mu\nu}(p-q)^\rho+$\\$~~~g^{\nu\rho}(q-k)^\mu+$\\$~~~g^{\rho\mu}(k-p)^\nu]$}  \\[1.0em]
\centered{$Z W^+W^-$\\interaction}             &  & \centered{$\feynmandiagram [ssmall,baseline=(v.base),horizontal=d to v] { {a[particle=\(W^\mu\)]} --[charged boson,momentum=\(k\)] v , v --[charged boson,momentum=\(q\)] b[particle=\(W^\nu\)], {d[particle=\(Z_\mu\)]} --[boson,momentum=\(p\)] v  };$} & \centered{$ig\cos(\theta_W)[g^{\mu\nu}(p-q)^\rho+$\\$~~~~~~~~~~~~~~g^{\nu\rho}(q-k)^\mu+$\\$~~~~~~~~~~~~~~g^{\rho\mu}(k-p)^\nu]$}  \\[1.0em]
