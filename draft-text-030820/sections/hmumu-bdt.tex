...
The classifier algorithm used is XGBoost BDT. 
...
\begin{figure}[htpb]
  ...
  \textbf{Low Purity}\\
  % \includegraphics[width=0.45\textwidth]{figures/hmm/public/postCut/histo-4lep1-muu.pdf}
  \includegraphics[width=0.45\textwidth]{example-image-a}
  \includegraphics[width=0.45\textwidth]{example-image-b}
  \caption{Distributions of \muu in the 4-lepton (left) and 3-lepton (right) categories after a cut on the BDT discriminant.}
